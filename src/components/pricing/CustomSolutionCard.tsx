...
const CustomSolutionCard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#1d2f84]/5 via-transparent to-[#1d2f84]/5 opacity-0 group-hover:opacity-100 transition-all duration-500" />
      
      <div className="relative z-10 flex flex-col md:flex-row gap-8">
        {/* Left Content */}
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-[#000001]/5 rounded-xl">
              <FiSettings size={24} className="text-[#1d2f84]" />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="p-1 rounded-full bg-[#1d2f84]/10">
                  <FiCheck className="text-[#1d2f84] w-4 h-4" />
                </div>
        ...
        <div className="flex flex-col justify-center items-center md:items-end space-y-4">
          <motion.a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#000001] text-[#FFFFFF] rounded-xl hover:bg-[#000001]/90 transition-colors group/button"
      ...
      {/* Decorative Elements */}
      <motion.div
        className="absolute -bottom-12 -right-12 w-48 h-48 bg-[#1d2f84]/5 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.1, 0.2, 0.1],
        }}
