...
const CustomSolutionCard: React.FC = () => {
  ...
  return (
    <motion.div
      className="p-8 rounded-2xl border-2 border-border bg-card relative overflow-hidden group"
      whileHover={{ y: -5 }}
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground">Custom Enterprise Solution</h3>
          </div>
        ...
        <div className="flex flex-col justify-center items-center md:items-end space-y-4">
          <motion.a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-foreground text-background rounded-xl hover:bg-foreground/90 transition-colors group/button"
