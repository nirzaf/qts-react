        ...
        >
            ...
            >
                ...
                >
                    ...
                    <button className="group px-8 py-4 rounded-full bg-card border border-border hover:border-primary/50 text-foreground font-semibold text-lg transition-all duration-300 hover:bg-accent flex items-center gap-2">
                        Start a Project <MousePointer2 className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                    </button>
                </motion.div>
            </motion.div>
...
const FloatingElements = ({ mouseX, mouseY }: { mouseX: any, mouseY: any }) => {
    ...
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            {/* Bottom Right Shape */}
            <motion.div
                style={{ x: useTransform(x, v => -v), y: useTransform(y, v => -v), rotate: useTransform(rotate, v => -v) }}
